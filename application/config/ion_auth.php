...
*/
$config['tables']['users']           = 'sip_users';
$config['tables']['groups']          = 'sip_groups';
$config['tables']['users_groups']    = 'sip_users_groups';
$config['tables']['login_attempts']  = 'sip_login_attempts';
 ...
 */
$config['site_title']                 = "sip2.skyrim.dev";       // Site Title, example.com
$config['admin_email']                = "no-reply@eskyrim.dev"; // Admin Email, admin@example.com
